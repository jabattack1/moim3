...
var leader1OutForProfile="<div id='teamContent' class='animated slideOutDown' onclick='closeLogin();return false;'><p class='marquee'>“If your actions inspire others to dream more, learn more, do more and become more, you are a leader.” John Quincy Adams</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='leadershipOut1();return false;'><h2 id='leaderHeading'>LEADERSHIP TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>The Leadership communicates with every team to ensure everything runs smoothly and everyone is on the same page.<br>As the main liaison to sponsors, vendors, and other external constituents, the Chief Officers also align MOI’M’s enterprises and activities with our mission.</h5><div class='memeberOne'><div id='leaderMemberFourPic' onclick='showProfileEun();return false;'></div></div></div>";
...
var events1OutForProfile="<div id='teamContent' class='animated slideOutDown' onclick='closeLogin();return false;'><p class='marquee'>“It’s not about ideas. It’s about making ideas happen.” Scott Belsky</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='eventTeamOut1();return false;'><h2 id='leaderHeading'>EVENTS TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>The Event Team defines who we are by producing events that have never been attempted before.<br>The team handles the logistics and planning of MOI’M events starting from pre-production to post-production.</h5><div class='memeberOne'><div id='eventsMemberFourPic' onclick='showProfileAmy();return false;'></div></div></div>";
var events1InFromProfile="<div id='teamContent' class='animated slideInUp' onclick='closeLogin();return false;'><p class='marquee'>“It’s not about ideas. It’s about making ideas happen.” Scott Belsky</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='eventTeamOut1();return false;'><h2 id='leaderHeading'>EVENTS TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>The Event Team defines who we are by producing events that have never been attempted before.<br>The team handles the logistics and planning of MOI’M events starting from pre-production to post-production.</h5><div class='memeberOne'><div id='eventsMemberFourPic' onclick='showProfileAmy();return false;'></div></div></div>";
// ***
...
var creative1OutForProfile="<div id='teamContent' class='animated slideOutDown' onclick='closeLogin();return false;'><p class='marquee'>“The desire to create is one of the deepest yearnings of the human soul.” Dieter F. Uchtdorf</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='creativeTeamOut1();return false;'><img id='forwardArrow' src = '/assets/arrowForward.png' onclick='creative2();return false;'><h2 id='leaderHeading'>CREATIVE TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>As the face of MOI’M, the Creative Team shapes our brand image.<br>The Creative Team creates not only all promotional materials for MOI’M, but also acts as the nerve center for every artistic aspect of our work.<br>It ensures that our design coheres with our mission to inspire through creative networking.</h5><div class='memeberOne'><div id='creativeMemberFourPic' onclick='showProfileSam();return false;'></div></div><div class='memeberTwo'><div id='creativeMemberFivePic' onclick='showProfileBella();return false;'></div></div><div class='memeberThree'><div id='creativeMemberSixPic' onclick='showProfileEunSung();return false;'></div></div></div>";
var creative1InFromProfile="<div id='teamContent' class='animated slideInUp' onclick='closeLogin();return false;'><p class='marquee'>“The desire to create is one of the deepest yearnings of the human soul.” Dieter F. Uchtdorf</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='creativeTeamOut1();return false;'><img id='forwardArrow' src = '/assets/arrowForward.png' onclick='creative2();return false;'><h2 id='leaderHeading'>CREATIVE TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>As the face of MOI’M, the Creative Team shapes our brand image.<br>The Creative Team creates not only all promotional materials for MOI’M, but also acts as the nerve center for every artistic aspect of our work.<br>It ensures that our design coheres with our mission to inspire through creative networking.</h5><div class='memeberOne'><div id='creativeMemberFourPic' onclick='showProfileSam();return false;'></div></div><div class='memeberTwo'><div id='creativeMemberFivePic' onclick='showProfileBella();return false;'></div></div><div class='memeberThree'><div id='creativeMemberSixPic' onclick='showProfileEunSung();return false;'></div></div></div>";
var creative2OutForProfile="<div id='teamContent' class='animated slideOutDown' onclick='closeLogin();return false;'><p class='marquee'>“The desire to create is one of the deepest yearnings of the human soul.” Dieter F. Uchtdorf</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='creativeTeamOut2();return false;'><h2 id='leaderHeading'>CREATIVE TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>As the face of MOI’M, the Creative Team shapes our brand image.<br>The Creative Team creates not only all promotional materials for MOI’M, but also acts as the nerve center for every artistic aspect of our work.<br>It ensures that our design coheres with our mission to inspire through creative networking.</h5><div class='memeberOne'><div id='creativeMemberSevenPic' onclick='showProfileSeung();return false;'></div></div><div class='memeberTwo'><div id='creativeMemberEightPic' onclick='showProfileWhitney();return false;'></div></div></div>";
var creative2InFromProfile="<div id='teamContent' class='animated slideInUp' onclick='closeLogin();return false;'><p class='marquee'>“The desire to create is one of the deepest yearnings of the human soul.” Dieter F. Uchtdorf</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='creativeTeamOut2();return false;'><h2 id='leaderHeading'>CREATIVE TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>As the face of MOI’M, the Creative Team shapes our brand image.<br>The Creative Team creates not only all promotional materials for MOI’M, but also acts as the nerve center for every artistic aspect of our work.<br>It ensures that our design coheres with our mission to inspire through creative networking.</h5><div class='memeberOne'><div id='creativeMemberSevenPic' onclick='showProfileSeung();return false;'></div></div><div class='memeberTwo'><div id='creativeMemberEightPic' onclick='showProfileWhitney();return false;'></div></div></div>";
...
var pr1OutForProfile="<div id='teamContent' class='animated slideOutDown' onclick='closeLogin();return false;'><p class='marquee'>“People do not buy goods and services. They buy relations, stories and magic.” Seth Godin</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='prTeamOut1();return false;'><h2 id='leaderHeading'>PUBLIC RELATIONS TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>In our current society where image is everything, it is important to maintain positive relationships with others<br>while projecting our brand during successful event promotion.<br>The Public Relations Team is responsible for communication with external constituents and all online and offline promotion of our events.</h5><div class='memeberOne'><div id='prMemberFourPic' onclick='showProfileHenry();return false;'></div></div><div class='memeberTwo'><div id='prMemberFivePic' onclick='showProfileHanna();return false;'></div></div><div class='memeberThree'><div id='prMemberSixPic' onclick='showProfileMinji();return false;'></div></div></div>";
var pr1InFromProfile="<div id='teamContent' class='animated slideInUp' onclick='closeLogin();return false;'><p class='marquee'>“People do not buy goods and services. They buy relations, stories and magic.” Seth Godin</p><img id='backArrow' src = '/assets/arrowBack.png' onclick='prTeamOut1();return false;'><h2 id='leaderHeading'>PUBLIC RELATIONS TEAM</h2><img id='membersLine' src = '/assets/line.png'><h5 id='teamIntro'>In our current society where image is everything, it is important to maintain positive relationships with others<br>while projecting our brand during successful event promotion.<br>The Public Relations Team is responsible for communication with external constituents and all online and offline promotion of our events.</h5><div class='memeberOne'><div id='prMemberFourPic' onclick='showProfileHenry();return false;'></div></div><div class='memeberTwo'><div id='prMemberFivePic' onclick='showProfileHanna();return false;'></div></div><div class='memeberThree'><div id='prMemberSixPic' onclick='showProfileMinji();return false;'></div></div></div>";
// ***
